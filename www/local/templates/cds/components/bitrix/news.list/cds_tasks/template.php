...
<ul class="tasks">
    <?php foreach ($arResult['ITEMS'] as $item) { ?>
        ...
        ?>
        <li class="tasks__item" id="<?php echo $this->GetEditAreaId($item['ID']); ?>">
            <div class="tasks__card">
                <h3 class="tasks__card-title"><?php echo htmlspecialcharsbx($item['NAME']); ?></h3>
                <?php if (!empty($item['PREVIEW_TEXT'])) { ?>
                    <div class="tasks__card-description"><?php echo $item['PREVIEW_TEXT']; ?></div>
                <?php } ?>
                <?php if ($iconSymbol) { ?>
